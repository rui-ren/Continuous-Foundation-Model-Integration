...
| Reviewable, pinned PowerShell installer for a central read-only Hermes observer | An installed fleet, per-node agent runtime, remote node execution, autonomous recovery, or robot control |
